...
(function () {
  ...
  var SPELLING_WOORDEN = [
    ...
    { naam: "de c die klinkt als /k/ (zoals cola, cactus)",
    ...
    { naam: "woorden op -tie (je hoort /(t)sie/, je schrijft tie)",
    ...
    { naam: "woorden op -isch (je hoort /ies/, je schrijft isch)",
    ...
    { naam: "de x die je als /ks/ hoort (zoals taxi, examen)",
    ...
    { naam: "de ch die klinkt als /sj/ (zoals chef, machine)",
    ...
    { naam: "de th die je als /t/ hoort (zoals thee, thema)",
    ...
    { naam: "woorden met aai, ooi of oei (je hoort /j/, je schrijft i)",
    ...
    { naam: "woorden met ei of ij (weetwoorden)",
    ...
    { naam: "woorden met au of ou (weetwoorden)",
    ...
    { naam: "woorden op /f/ die met v worden verlengd (duif → duiven)",
    ...
    { naam: "woorden op /s/ die met z worden verlengd (huis → huizen)",
    ...
    { naam: "verkleinwoorden (-je, -tje, -etje …)",
      test: /verkleinwoord|verkleining/,
      woorden: ["boom", "bloem", "man", "bal", "stoel", "koning", "raam", "huis", "kar", "tafel"] },
    { naam: "open en gesloten lettergrepen (verdubbelen of verlengen: man → mannen, maan → manen)",
