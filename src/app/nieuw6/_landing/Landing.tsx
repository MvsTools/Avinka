...
// ⚠️ WERKBANK-KOPIE: hier op `true`, in het origineel op `false`.
// Op de echte pagina staat de ervaringen-sectie uit tot er echte quotes zijn.
// Voor het mobiele ontwerp moeten we hem wél zien, anders richten we een
// sectie niet in die er bij de lancering gewoon staat.
// 🔴 Neem dit verschil NIET mee terug naar het origineel.
const TOON_ERVARINGEN = true;
